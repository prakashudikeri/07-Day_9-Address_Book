...
public class AddressBookMain {
	 public static void main(String[] args) {
        System.out.println("Welcome to Address Book System Problem ");
        	int choice;
        AddressBook addressBook = new AddressBook();								        	//AddressBook Class Object for Contact Management
    ...
    switch (choice) {
        case 1:																				//Adding New Contact Details
            addressBook.addNewContact();
            break;
        case 2:																				//Edit Contact Details
            addressBook.editContact();
            break;
        case 3:
            break;
        case 4:																			     //Show Contact Details
